...
<TD style="border:0;">
	...
	<TBODY><TR>
	<TD valign="top" bgcolor="#492dd9"><IMG src="./myimages/banner_top.jpg" border="0" width="1200" height="200">></TD>
	</TR>
	<TR>
	<TD height="100%" valign="top" width="100%">
		...
		<TD nalign="middle">
			...
			<A href="hello.jsp" class="nav">Login</A>
...
<SPAN class="devName">WebLockers Staff</SPAN><BR> 
</TD>
</TR>
</TBODY></TABLE>
